...
export interface TokenInterface extends utils.Interface {
  ...
  functions: {
    ...
    "excludedFromTax(address)": FunctionFragment;
    "increaseAllowance(address,uint256)": FunctionFragment;
    "name()": FunctionFragment;
    "owner()": FunctionFragment;
    "renounceOwnership()": FunctionFragment;
    "setDevAddress(address)": FunctionFragment;
    "setTaxExclusion(address,bool)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "excludedFromTax",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setTaxExclusion",
...
export interface Token extends BaseContract {
  ...
  excludedFromTax(arg0: string, overrides?: CallOverrides): Promise<boolean>;
